package com.example.knowledgesport;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iv_athlete = (ImageView) findViewById(R.id.iv_athlete);

        b_answer1 = (Button) findViewById(R.id.b_answer1);
        b_answer2 = (Button) findViewById(R.id.b_answer4);
        b_answer3 = (Button) findViewById(R.id.b_answer3);
        b_answer4 = (Button) findViewById(R.id.b_answer2);


        list = new ArrayList<>();

        for(int i = 0; i < new Database().answers.length; i++) {
            list.add(new ImageItem(new Database().answers[i], new Database().athletes[i]));
        }
        ...
        b_answer1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(turn < list.size()) {
                    ...
                    Toast.makeText((MainActivity.this), "Gra skończona!", Toast.LENGTH_SHORT).show();
                    finish();
                }

                } else {
                    Toast.makeText(MainActivity.this, "Źle!", Toast.LENGTH_SHORT).show();
                    Toast.makeText(MainActivity.this, "Przegrałeś!", Toast.LENGTH_SHORT).show();
                    finish();
                }
    ...
    private void newQuestion(int number) {
        iv_athlete.setImageResource(list.get(number - 1).getImage());
